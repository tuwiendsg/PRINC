...
{
    public class TriggerDataSet : DP_Shape
    {
        ...
        public TriggerDataSet()
        {
        }

        public TriggerDataSet(Point startLocation) :
            base(startLocation)
        {
            Diagram = new TriggerDataSetStructure();
            Text = new DP_Text();
        ...
        {
            TriggerDataSet newType = new TriggerDataSet();
            newType.Diagram = new TriggerDataSetStructure();
        ...
        {
            if (source is TriggerDataSet)
            {
              base.Copy(source);
              TriggerDataSet srcTriggerDataSet = source as TriggerDataSet;
            }
        }
    }
}
