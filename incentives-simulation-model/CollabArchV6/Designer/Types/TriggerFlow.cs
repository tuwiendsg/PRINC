...
{
    public class TriggerFlow : DP_Line
    {
        ...
        public TriggerFlow(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new TriggerFlowStructure();
            Text = new DP_Text();
        ...
        {
            TriggerFlow newType = new TriggerFlow();
            newType.Diagram = new TriggerFlowStructure();
        ...
        {
            if (source is TriggerFlow)
            {
              base.Copy(source);
              TriggerFlow srcTriggerFlow = source as TriggerFlow;
            }
        }
    }
}
