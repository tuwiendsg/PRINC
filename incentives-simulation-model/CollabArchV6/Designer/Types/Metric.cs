...
namespace Designer.Types
{
    public class Metric : DP_Shape
    {
        ...
        public Metric(Point startLocation) :
            base(startLocation)
        {
            Diagram = new MetricStructure();
            Text = new DP_Text();
        }
        ...
        {
            Metric newType = new Metric();
            newType.Diagram = new MetricStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Metric srcMetric = source as Metric;
        ImplementationType = srcMetric.ImplementationType;
        InitialValue = srcMetric.InitialValue;
            }
        }
    }
}
