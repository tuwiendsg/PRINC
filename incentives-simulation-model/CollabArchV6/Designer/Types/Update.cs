...
{
    public class Update : CollabAction
    {
        ...
        public Update(Point startLocation) :
            base(startLocation)
        {
            Diagram = new UpdateStructure();
            Text = new DP_Text();
        ...
        {
            Update newType = new Update();
            newType.Diagram = new UpdateStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Update srcUpdate = source as Update;
        ResourceDependency = srcUpdate.ResourceDependency;
        ResourceRequest = srcUpdate.ResourceRequest;
            }
        }
    }
}
