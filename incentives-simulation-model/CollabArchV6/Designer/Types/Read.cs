...
{
    public class Read : CollabAction
    {
        ...
        public Read(Point startLocation) :
            base(startLocation)
        {
            Diagram = new ReadStructure();
            Text = new DP_Text();
        ...
        {
            Read newType = new Read();
            newType.Diagram = new ReadStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Read srcRead = source as Read;
        ResourceDependency = srcRead.ResourceDependency;
        ResourceRequest = srcRead.ResourceRequest;
            }
        }
    }
}
