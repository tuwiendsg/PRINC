...
{
    public class Create : CollabAction
    {
        ...
        public Create(Point startLocation) :
            base(startLocation)
        {
            Diagram = new CreateStructure();
            Text = new DP_Text();
        ...
        {
            Create newType = new Create();
            newType.Diagram = new CreateStructure();
        ...
        protected override void Copy(DP_ConcreteType source)
        {
            ...
            {
              base.Copy(source);
              Create srcCreate = source as Create;
        ResourceDependency = srcCreate.ResourceDependency;
        ResourceRequest = srcCreate.ResourceRequest;
            }
        }
    }
}
