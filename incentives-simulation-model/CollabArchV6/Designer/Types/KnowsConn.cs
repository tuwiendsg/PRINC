...
{
    public class KnowsConn : DP_Line
    {
        ...
        public KnowsConn(DomainProDesigner.DP_ConnectionSpec newRole1, DomainProDesigner.DP_ConnectionSpec newRole2) :
            base(newRole1, newRole2)
        {
            Diagram = new KnowsConnStructure();
            Text = new DP_Text();
        }
        ...
        {
            KnowsConn newType = new KnowsConn();
            newType.Diagram = new KnowsConnStructure();
        ...
        {
            if (source is KnowsConn)
            {
              base.Copy(source);
              KnowsConn srcKnowsConn = source as KnowsConn;
            }
        }
    }
}
